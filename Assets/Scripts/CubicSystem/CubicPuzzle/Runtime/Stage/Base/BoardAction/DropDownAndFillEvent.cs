...
namespace CubicSystem.CubicPuzzle
{
     ...
     */
    public class DropDownAndFillEvent :IDropAndFillEvent
    {
        //Block 이동 속도
        ...
        public DropDownAndFillEvent(BoardModel board)
        {
            stepCount = 0;
            this.board = board;
        ...
        public async UniTask StartDropAndFill() {
            if(board.BoardType == BoardType.HEX) {
                await StartHexDropAndFill();
            }
            else {
                await StartSquareDropAndFill();
            }
        }

        /**
         *  @brief  HexBlock Drop and Fill Event
         */
        public async UniTask StartHexDropAndFill()
        {
            bool isMoveBlock;
        ...
        /**
         *  @brief  SquareBlock Drop and Fill Event
         */
        public async UniTask StartSquareDropAndFill()
        {
